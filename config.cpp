class CfgPatches
{
    class ld3k_gm6_lynx_127x108_compat_ace3
    {
        ...
        units[]=
        {
            ...
            "Item_ld3k_gm6_127x108_optic_AMS_Night_Vision",
            "Item_ld3k_gm6_127x108_optic_AMS_Night_Vision_khk",
            "Item_ld3k_gm6_127x108_optic_AMS_Night_Vision_snd",
            "Item_ld3k_gm6_127x108_optic_KHS_Night_Vision_blk",
            "Item_ld3k_gm6_127x108_optic_KHS_Night_Vision_hex",
            "Item_ld3k_gm6_127x108_optic_KHS_old_Night_Vision",
            "Item_ld3k_gm6_127x108_optic_KHS_Night_Vision_tan"
        };
        weapons[]=
        {
            ...
            "ld3k_gm6_127x108_optic_AMS_Night_Vision",
            "ld3k_gm6_127x108_optic_AMS_Night_Vision_khk",
            "ld3k_gm6_127x108_optic_AMS_Night_Vision_snd",
            "ld3k_gm6_127x108_optic_KHS_Night_Vision_blk",
            "ld3k_gm6_127x108_optic_KHS_Night_Vision_hex",
            "ld3k_gm6_127x108_optic_KHS_old_Night_Vision",
            "ld3k_gm6_127x108_optic_KHS_Night_Vision_tan"
        };
    };
};
class SlotInfo;
...
class asdg_OpticRail1913: asdg_OpticRail
{
    class compatibleItems
    {
        ...
        ld3k_gm6_127x108_optic_AMS_Night_Vision=1;
        ld3k_gm6_127x108_optic_AMS_Night_Vision_khk=1;
        ld3k_gm6_127x108_optic_AMS_Night_Vision_snd=1;
        ld3k_gm6_127x108_optic_KHS_Night_Vision_blk=1;
        ld3k_gm6_127x108_optic_KHS_Night_Vision_hex=1;
        ld3k_gm6_127x108_optic_KHS_old_Night_Vision=1;
        ld3k_gm6_127x108_optic_KHS_Night_Vision_tan=1;
    };
};
...
class CfgAmmo
{
    ...
    class ld3k_B_127x108_Ball_7N34: BulletBase // 12.7mm 7N34 sniper cartridge https://roe.ru/production/sukhoputnye_voyska/small-arms-sv/boepripasy_k_strelkovomu_oruzhiyu/12_7/7n34/?theme=theme-green
    {
        ...
        hit=32.7; // 18617 Joules, B_127x108_Ball 35 19906 Joules
        indirectHit=0;
        indirectHitRange=0;
        cartridge="FxCartridge_127";
        visibleFire=5;
        ...
        cost=5;
        airLock=1;
        caliber=2.8; // ??? Penetration 10mm at 800m, perforation in-game 12mm RHA "armour_plate_12mm.bisurf" ~520m/s: caliber ~1.55 https://roe.ru/production/land-forces/small-arms-sv/small-arms-ammunition-sv/12-7-108/7n34/?theme=theme-green
        typicalSpeed=793; // 18617 Joules, B_127x108_Ball 820 19906 Joules
        timeToLive=10;
        model="\A3\Weapons_f\Data\bullettracer\tracer_green";
        tracerScale=1.5;
        tracerStartTime=0.075;
    ...
    class ld3k_B_127x108_APDS: ld3k_B_127x108_Ball_7N34 // ACE3 https://github.com/acemod/ACE3/pull/9191
    {
        ...
        hit=61.2; // 16032 Joules, B_127x108_Ball 60 15705 Joules
        indirectHit=0;
        indirectHitRange=0;
        caliber=3.6; // ???
        typicalSpeed=1071; // 16032 Joules, B_127x108_Ball 1060 15705 Joules
    ...
    class ld3k_B_127x108_Ball_B32_API: ld3k_B_127x108_APDS // https://en.wikipedia.org/wiki/12.7_%C3%97_108_mm https://bigenc.ru/c/12-7-mm-krupnokalibernye-patrony-12-7x108-d40c5a https://web.archive.org/web/20140108183108/http://gunsru.ru/rg_patron_12_7x107_ru.html https://gunrf.ru/rg_patron_12_7x107_ru.html
    {
        ...
        // caliber=3.6; // ??? Penetration 20mm at 100m, perforation in-game 23mm RHA "armour_plate_23mm.bisurf" ~740m/s: caliber ~2 https://roe.ru/production/land-forces/small-arms-sv/small-arms-ammunition-sv/12-7-108/57-bz-542/?theme=theme-green
        typicalSpeed=829;
    ...
    class ld3k_B_127x108_Ball_BZT44M_API_Tracer_Green: ld3k_B_127x108_Ball_B32_API // https://bigenc.ru/c/12-7-mm-krupnokalibernye-patrony-12-7x108-d40c5a https://web.archive.org/web/20140108183108/http://gunsru.ru/rg_patron_12_7x107_ru.html https://gunrf.ru/rg_patron_12_7x107_ru.html
    {
        ...
        ACE_bulletMass=43.9;
        // caliber=3.6; // ??? Penetration 15mm at 100m, perforation in-game 16mm RHA "armour_plate_16mm.bisurf" ~740m/s: caliber ~1.45 https://roe.ru/production/land-forces/small-arms-sv/small-arms-ammunition-sv/12-7-108/57-bzt-542m/?theme=theme-green
...
class CfgMagazineWells
{
    class GM6_127x108 // official BI tool All-in-one Config Arma3 2.19.152694 https://community.bistudio.com/wiki/Arma:_All-in-one_Config
    {
        ...
        ld3k_Magazines[]= // Weapon initSpeed -1 with GM6 Lynx ACE_barrelLength 730mm (28.74"), 748, 1010, 781, 802m/s ICAO conditions (15°C, 1013.25 hPa, 0%) according to GM6 Lynx 5Rnd_127x108 magazines initSpeed
        {
...
class CfgWeapons
{
    ...
    class ld3k_GM6_Lynx_127x108: srifle_GM6_F
    {
        ...
        maxZeroing=3900; // distance 12.7x108mm APDS Mach 0.8 (272m/s) ICAO, GM6_base_F 2200
    ...
    class ld3k_gm6_127x108_optic_LRPS_Night_Vision: optic_LRPS // Nightforce NXS 5.5-22x56
    {
        ...
        class ItemInfo: ItemInfo
        {
            ...
            class OpticsModes: OpticsModes
            {
                class Snip: Snip
                {
                    ...
                    discreteDistance[]={100,200,300,400,500,600,700,800,900,1000,1100,1200,1300,1400,1500,1600,1700,1800,1900,2000,2100,2200,2300,2400,2500,2600,2700,2800}; // 2800m max distance at max elevation 29 mRad 12.7x108mm APDS (zeroing 100m, ICAO conditions)
                    discreteDistanceInitIndex=0; // optic_LRPS 2
                    distanceZoomMin=100; // optic_LRPS 300
                    distanceZoomMax=2800; // optic_LRPS 2400
    ...
    class ld3k_gm6_127x108_optic_AMS_base_Night_Vision: optic_AMS_base // US Optics MR-10
    {
        ACE_ScopeZeroRange=100; // Always keep vanilla discreteDistance 100 same that Range Card zeroed distance, to increase eventually zeroing distance: Interaction Menu -> "Set zero adjustment" (AB enabled only)
        ...
        author="Laid3acK";
        _generalMacro="ld3k_gm6_127x108_optic_AMS_base_Night_Vision";
        class ItemInfo: ItemInfo
        {
            ...
            class OpticsModes: OpticsModes
            {
                class AMS: AMS
                {
                    ...
                    discreteDistance[]={100,200,300,400,500,600,700,800,900,1000,1100,1200,1300,1400,1500,1600,1700,1800,1900,2000,2100}; // 2100m max distance at max elevation 16 mRad 12.7x108mm APDS (zeroing 100m, ICAO conditions)
                    discreteDistanceInitIndex=0; // optic_AMS_base 2
                    distanceZoomMin=100; // optic_AMS_base 300
                    distanceZoomMax=2100; // optic_AMS_base 2000
                    discretefov[]={0.075,0.025}; // optic_AMS_base
                    modelOptics[]=
                    {
                        "\ld3k_gm6_lynx_127x108_compat_ace3\acc\ld3k_reticle_acco_ams_F",
                        "\ld3k_gm6_lynx_127x108_compat_ace3\acc\ld3k_reticle_acco_ams_z_F"
                    };
                    visionMode[]=
                    {
                        "Normal",
    ...
    class ld3k_gm6_127x108_optic_AMS_Night_Vision: ld3k_gm6_127x108_optic_AMS_base_Night_Vision
    {
        author="Laid3acK";
        _generalMacro="ld3k_gm6_127x108_optic_AMS_Night_Vision";
        scope=2;
        scopeCurator=1;
        scopeArsenal=2;
    ...
    class ld3k_gm6_127x108_optic_AMS_Night_Vision_khk: ld3k_gm6_127x108_optic_AMS_Night_Vision
    {
        author="Laid3acK";
        _generalMacro="ld3k_gm6_127x108_optic_AMS_Night_Vision_khk";
    ...
    class ld3k_gm6_127x108_optic_AMS_Night_Vision_snd: ld3k_gm6_127x108_optic_AMS_Night_Vision
    {
        author="Laid3acK";
        _generalMacro="ld3k_gm6_127x108_optic_AMS_Night_Vision_snd";
    ...
    class ld3k_gm6_127x108_optic_KHS_base_Night_Vision: optic_KHS_base // KAHLES HELIA 2.4-12x56
    {
        ACE_ScopeZeroRange=100; // Always keep vanilla discreteDistance 100 same that Range Card zeroed distance, to increase eventually zeroing distance: Interaction Menu -> "Set zero adjustment" (AB enabled only)
        ...
        ACE_ScopeAdjust_HorizontalIncrement=0.1;
        author="Laid3acK";
        _generalMacro="ld3k_gm6_127x108_optic_KHS_base_Night_Vision";
        class ItemInfo: ItemInfo
        {
            ...
            class OpticsModes: OpticsModes
            {
                class KHS: KHS
                {
                    ...
                    discreteDistance[]={100,200,300,400,500,600,700,800,900,1000,1100,1200,1300,1400,1500,1600,1700,1800,1900,2000,2100,2200,2300}; // 2300m max distance at max elevation 19 mRad 12.7x108mm APDS (zeroing 100m, ICAO conditions)
                    discreteDistanceInitIndex=0; // optic_KHS_base 2
                    distanceZoomMin=100; // optic_KHS_base 300
                    distanceZoomMax=2300; // optic_KHS_base 2000
                    discretefov[]={0.0536,0.0227}; // optic_KHS_base
                    modelOptics[]=
                    {
                        "\ld3k_gm6_lynx_127x108_compat_ace3\acc\ld3k_reticle_acco_khs_F",
                        "\ld3k_gm6_lynx_127x108_compat_ace3\acc\ld3k_reticle_acco_khs_z_F"
                    };
                    visionMode[]=
                    {
                        "Normal",
    ...
    class ld3k_gm6_127x108_optic_KHS_Night_Vision_blk: ld3k_gm6_127x108_optic_KHS_base_Night_Vision
    {
        author="Laid3acK";
        _generalMacro="ld3k_gm6_127x108_optic_KHS_Night_Vision_blk";
        scope=2;
        scopeCurator=1;
        scopeArsenal=2;
    ...
    class ld3k_gm6_127x108_optic_KHS_Night_Vision_hex: ld3k_gm6_127x108_optic_KHS_Night_Vision_blk
    {
        author="Laid3acK";
        _generalMacro="ld3k_gm6_127x108_optic_KHS_Night_Vision_hex";
    ...
    class ld3k_gm6_127x108_optic_KHS_old_Night_Vision: optic_KHS_old // KAHLES HELIA 2.4-12x56
    {
        ACE_ScopeZeroRange=100; // Always keep vanilla discreteDistance 100 same that Range Card zeroed distance, to increase eventually zeroing distance: Interaction Menu -> "Set zero adjustment" (AB enabled only)
        ACE_ScopeHeightAboveRail=4.30723;
        ACE_ScopeAdjust_Vertical[]={0,19}; // HELIA 2.4-12x56
        ...
        ACE_ScopeAdjust_HorizontalIncrement=0.1;
        author="Laid3acK";
        _generalMacro="ld3k_gm6_127x108_optic_KHS_old_Night_Vision";
    ...
    class ld3k_gm6_127x108_optic_KHS_Night_Vision_tan: ld3k_gm6_127x108_optic_KHS_Night_Vision_blk
    {
        author="Laid3acK";
        _generalMacro="ld3k_gm6_127x108_optic_KHS_Night_Vision_tan";
...
class CfgVehicles
{
    ...
    class Item_ld3k_gm6_127x108_optic_AMS_Night_Vision: Item_Base_F
    {
        scope=2;
        scopeCurator=2;
        displayName="AMS Night Vision (Black)";
        ...
        class TransportItems
        {
            class ld3k_gm6_127x108_optic_AMS_Night_Vision
            {
                name="ld3k_gm6_127x108_optic_AMS_Night_Vision";
                count=1;
            };
        };
    };
    class Item_ld3k_gm6_127x108_optic_AMS_Night_Vision_khk: Item_Base_F
    {
        scope=2;
        scopeCurator=2;
        displayName="AMS Night Vision (Khaki)";
        ...
        class TransportItems
        {
            class ld3k_gm6_127x108_optic_AMS_Night_Vision_khk
            {
                name="ld3k_gm6_127x108_optic_AMS_Night_Vision_khk";
                count=1;
            };
        };
    };
    class Item_ld3k_gm6_127x108_optic_AMS_Night_Vision_snd: Item_Base_F
    {
        scope=2;
        scopeCurator=2;
        displayName="AMS Night Vision (Sand)";
        ...
        class TransportItems
        {
            class ld3k_gm6_127x108_optic_AMS_Night_Vision_snd
            {
                name="ld3k_gm6_127x108_optic_AMS_Night_Vision_snd";
                count=1;
            };
        };
    };
    class Item_ld3k_gm6_127x108_optic_KHS_Night_Vision_blk: Item_Base_F
    {
        scope=2;
        scopeCurator=2;
        displayName="Kahlia Night Vision (Black)";
        ...
        class TransportItems
        {
            class ld3k_gm6_127x108_optic_KHS_Night_Vision_blk
            {
                name="ld3k_gm6_127x108_optic_KHS_Night_Vision_blk";
                count=1;
            };
        };
    };
    class Item_ld3k_gm6_127x108_optic_KHS_Night_Vision_hex: Item_Base_F
    {
        scope=2;
        scopeCurator=2;
        displayName="Kahlia Night Vision (Hex)";
        ...
        class TransportItems
        {
            class ld3k_gm6_127x108_optic_KHS_Night_Vision_hex
            {
                name="ld3k_gm6_127x108_optic_KHS_Night_Vision_hex";
                count=1;
            };
        };
    };
    class Item_ld3k_gm6_127x108_optic_KHS_old_Night_Vision: Item_Base_F
    {
        scope=2;
        scopeCurator=2;
        displayName="Kahlia Night Vision (Old)";
        ...
        class TransportItems
        {
            class ld3k_gm6_127x108_optic_KHS_old_Night_Vision
            {
                name="ld3k_gm6_127x108_optic_KHS_old_Night_Vision";
                count=1;
            };
        };
    };
    class Item_ld3k_gm6_127x108_optic_KHS_Night_Vision_tan: Item_Base_F
    {
        scope=2;
        scopeCurator=2;
        displayName="Kahlia Night Vision (Tan)";
        ...
        class TransportItems
        {
            class ld3k_gm6_127x108_optic_KHS_Night_Vision_tan
            {
                name="ld3k_gm6_127x108_optic_KHS_Night_Vision_tan";
                count=1;
            };
        };
    };
